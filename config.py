CONFIG = {
    ...
    'telegram_token': 'tg_bot_token', # 在telegram里面 @bot_father 申请一个bot
    'telegram_chat_id': 'tg_chat_id', # 按照这个 https://zhuanlan.zhihu.com/p/602213485 拿到 chat id
    ...
    'port': 65331,       # 服务器端口
    'api_key': 'bearer_api_key',  # singlefile直接上传文件到 restful api 的 Bearer Key
