CONFIG = {
    ...
    'github_repo': 'cuijianzhuang/web_clipper_db', # 开一个repo，可以private，填入你的github用户名和repo名称
    'github_token': 'github_token',  # 开一个 token，需要授权到上面那个repo的权限
    'github_pages_domain': 'cuijianzhuang.github.io', # repo开启pages，然后这里写上域名，类似 https://username.github.io/repo
    'notion_database_id': '19f32fd5f34e8066ae84cfe6577fc580', # 创建一个新页面，格式为table，然后参照这个 https://blog.csdn.net/weixin_46014809/article/details/132631030 拿到id
    ...
    'ai_provider': 'azure',  # 或 'openai'
    'azure_api_key': 'azure_api_key',
    'azure_api_base': 'https://cuiplus.openai.azure.com/',
    'azure_api_version': '2024-02-15-preview',  # 可选，默认为最新版本
    'azure_deployment_name': 'gpt-35-turbo',  # 部署模型的名称
